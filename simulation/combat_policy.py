...
TIER_CONFIGS = {
    "micro":  dict(entity_dim=8,  unique_dim=16, backbone_hidden=32,  backbone_layers=1, gru_hidden=16),
    "small":  dict(entity_dim=12, unique_dim=24, backbone_hidden=48,  backbone_layers=1, gru_hidden=24),
    "medium": dict(entity_dim=16, unique_dim=32, backbone_hidden=64,  backbone_layers=2, gru_hidden=32),
    "large":  dict(entity_dim=16, unique_dim=32, backbone_hidden=96,  backbone_layers=2, gru_hidden=48),
    "xl":     dict(entity_dim=24, unique_dim=48, backbone_hidden=128, backbone_layers=3, gru_hidden=64),
}
